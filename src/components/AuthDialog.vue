  ...
  <template v-if="authOpen">
    ...
    <div :style="s.authCard">
      ...
      <div v-else :style="s.authRow">
        <button :style="s.authBtn" v-hover-style="s.addBtnHover" :disabled="authBusy || !configurationReady" aria-label="Continue with Google" @click="auth.loginGoogle()">
          <svg width="22" height="22" viewBox="0 0 48 48">
            ...
            <path fill="#4CAF50" d="M24 44c5.2 0 9.9-2 13.4-5.2l-6.2-5.2C29.2 35 26.7 36 24 36c-5.3 0-9.7-3.1-11.3-7.9l-6.5 5C9.5 39.6 16.2 44 24 44z"/>
            <path fill="#1976D2" d="M43.6 20.5H42V20H24v8h11.3c-.8 2.2-2.2 4.1-4.1 5.6l6.2 5.2C41.4 36.6 44 30.9 44 24c0-1.3-.1-2.3-.4-3.5z"/>
          </svg>
        </button>
        <button :style="s.authBtn" v-hover-style="s.addBtnHover" :disabled="authBusy || !configurationReady" aria-label="Continue with GitHub" @click="auth.loginGithub()">
      ...
      <span v-if="!configurationReady" :style="s.authError">Add the Firebase and owner allowlist keys from .env.example.</span>
