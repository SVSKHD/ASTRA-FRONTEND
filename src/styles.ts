...
export function buildStyles(c: Theme, dark: boolean, isMobile: boolean) {
  ...
  const s: Record<string, Style> = {
    ...
    dayGroupLabel: { display: 'flex', alignItems: 'center', gap: 'var(--sp-2)' },
    // The per-day tally: one chip per status, so a group reads at a glance.
    dayStats: { display: 'flex', alignItems: 'center', gap: 'var(--sp-2)', flexWrap: 'wrap' },
    ...
    filterRow: { display: 'flex', alignItems: 'center', gap: 'var(--sp-2)', flexWrap: 'wrap' },
    tagPicker: {
      display: 'flex',
      flexDirection: 'column',
      gap: 'var(--sp-2)',
    ...
    taskViewMeta: { display: 'flex', flexWrap: 'wrap', gap: 'var(--sp-3)' },
    taskViewMetaItem: {
      display: 'flex',
      flexDirection: 'column',
      gap: 3,
    ...
    tabStageRow: { display: 'flex', alignItems: 'center', gap: 'var(--sp-2)', minWidth: 0 },
    tabStageLabel: {
      ...typeStep('sm'),
      fontWeight: 'var(--weight-semibold)',
    ...
    tabDots: { display: 'flex', alignItems: 'center', gap: 'var(--sp-1)' },
    tabScroll: {
      position: 'relative',
      display: 'flex',
      gap: isMobile ? 4 : 3,
    ...
    chipRow: { display: 'flex', gap: 'var(--sp-2)', flexWrap: 'wrap' },
    chip: {
      alignSelf: 'flex-start',
      ...typeStep('2xs'),
      padding: '2px 8px',
    ...
    noteCardFoot: { display: 'flex', alignItems: 'center', gap: 'var(--sp-2)', flexWrap: 'wrap' },
    noteCardActions: { display: 'flex', gap: 'var(--sp-1)', marginLeft: 'auto' },
    noteViewOverlay: {
      position: 'fixed',
      inset: 0,
      zIndex: 17,
    ...
    ghGrid: { display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 'var(--sp-2)' },
    ghItem: {
      display: 'flex',
      flexDirection: 'column',
      gap: 2,
    ...
    dialogHeader: { display: 'flex', alignItems: 'center', gap: 'var(--sp-3)' },
    dialogHeading: {
      flex: 1,
      ...typeStep('base'),
      fontWeight: 'var(--weight-semibold)',
    ...
    dialogRow: { display: 'flex', gap: 'var(--sp-2)', flexWrap: 'wrap' },
    dialogNotes: {
      minHeight: 70,
      padding: '12px 14px',
      borderRadius: 'var(--radius-dialog)',
    ...
    dialogActions: { display: 'flex', gap: 'var(--sp-2)', justifyContent: 'flex-end' },
    notifBanner: {
      position: 'fixed',
      top: isMobile ? 70 : 20,
      left: '50%',
    ...
    weekdayRow: { display: 'flex', gap: 'var(--sp-2)' },
    shareCard: {
      position: 'fixed',
      top: '50%',
      left: '50%',
    ...
    authRow: { display: 'flex', gap: 'var(--sp-3)', width: '100%' },
    authBtn: {
      flex: 1,
      padding: '15px',
      borderRadius: 'var(--radius-dialog)',
