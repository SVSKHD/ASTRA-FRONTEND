...
import { usableEnvValue } from '@/utils/env'

export { supabaseEnabled }

const config = {
  apiKey: usableEnvValue(import.meta.env.VITE_FIREBASE_API_KEY),
  authDomain: usableEnvValue(import.meta.env.VITE_FIREBASE_AUTH_DOMAIN),
  databaseURL: usableEnvValue(import.meta.env.VITE_FIREBASE_DATABASE_URL),
  projectId: usableEnvValue(import.meta.env.VITE_FIREBASE_PROJECT_ID),
  storageBucket: usableEnvValue(import.meta.env.VITE_FIREBASE_STORAGE_BUCKET),
  messagingSenderId: usableEnvValue(import.meta.env.VITE_FIREBASE_MESSAGING_SENDER_ID),
  appId: usableEnvValue(import.meta.env.VITE_FIREBASE_APP_ID),
  measurementId: usableEnvValue(import.meta.env.VITE_FIREBASE_MEASUREMENT_ID),
}
