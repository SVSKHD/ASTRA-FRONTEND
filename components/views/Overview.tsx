  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <MarketStatsCard
          title="Total Balance"
          value={activeAccount ? formatCurrency(activeAccount.balance ?? 0) : `${currencySymbol}0.00`}
          icon={Wallet}
        ...
        <MarketStatsCard
          title="Equity"
          value={activeAccount ? formatCurrency(activeAccount.equity ?? 0) : `${currencySymbol}0.00`}
          icon={Activity}
